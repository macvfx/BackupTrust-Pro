...
Version 2.3 fixes nested Lucid mount recognition and adds **Refresh Paths**, checks for `lucid` and `lucid2`, and diagnostic logs for unavailable-path run rejections.
...
- [Release notes](RELEASE-NOTES-2.3-BUILD-23.md)
- [Encryption testing guide](ENCRYPTION-TESTING.md)
- Earlier release notes: [2.2 (22)](RELEASE-NOTES-2.2-BUILD-22.md), [2.1 (21)](RELEASE-NOTES-2.1-BUILD-21.md), [2.0 (20)](docs/releases/RELEASE-NOTES-2.0-BUILD-20.md)
